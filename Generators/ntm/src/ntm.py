...
print("HELLO TEST")
print("NTMControllerState:", NTMControllerState)
class NTMCell(tf.contrib.rnn.RNNCell):
    ...
    def __call__(self, x, prev_state):
        ...
        self.step += 1
        print("NTMControllerState(controller_state=controller_state, read_vector_list=read_vector_list, w_list=w_list, M=M):", NTMControllerState(
